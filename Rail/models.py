...
class country_province(models.Model):
    ...
    def __unicode__(self):
        return u'%s %s' % (self.country.Name, self.province.Name)

    class Meta:
        verbose_name = 'rel country province'
        db_table = 'country_province'
...
class Rail_Class(models.Model):
    Name = models.CharField(max_length=100, verbose_name='Rail Class')
    '''
...
class Rail_Platform(models.Model):
    ...
    def __unicode__(self):
        return u'%s' % (self.Name)
#        return u'%s %s' % (self.Name, self.Description)  # this will impact m2m for IE
...
class End_User(models.Model):
    Name = models.CharField(max_length=300,blank = True, verbose_name='End User')
...
class Decision_Maker(models.Model):
    Name = models.CharField(max_length=300,blank = True, verbose_name='Decision Maker')
    
    class Meta:
        verbose_name = 'Decision Maker'
        db_table = 'decision_maker'
        
    def __unicode__(self):
        return u'%s' % (self.Name)
        
class Rail_Vehicle_Project(models.Model):
    Vehicle_project_no = models.CharField(max_length=100,verbose_name='End User Project')
    Description = models.TextField(max_length=300,blank = True, null=True, verbose_name='Description')
    Line_Length = models.FloatField(blank=True, null=True,verbose_name='Line Length')
    Created_by = models.CharField(max_length=100,blank=True, null=True,verbose_name='Created By')
    Created_date = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='Created Date')
    Last_modified_date = models.DateField(auto_now=True, auto_now_add=True,blank=True, null=True,verbose_name='Last Modified Date')
    End_User = models.ForeignKey(End_User,verbose_name='End User')
...
class Rail_OEM_Project(models.Model):
    oem_project_code = models.CharField(max_length=10,verbose_name='OEM Project Code') # here "oem_project_code" can be replaced by "id", just change verbose_name
    ...
    vehicle_project_status = models.CharField(max_length=50,choices=
                                                                                            ...
                                                                                            ('01 - Reach Goal','01 - Reach Goal'),
                                                                                            ('02 - New Project','02 - New Project'),
                                                                                            ('03 - RFQ','03 - RFQ'),
                                                                                            ('04 - Running','04 - Running'),
                                                                                            ('05 - Offer Placed','05 - Offer Placed'),
                                                                                            ('06 - BAFO Placed','06 - BAFO Placed'),
                                                                                            ('07 - Project Cancelled','07 - Project Cancelled'),
                                                                                            ('08 - Project on Hold','08 - Project on Hold'),
                                                                                            ('09 - Voith Contribution Cancelled','09 - Voith Contribution Cancelled'),
                                                                                            ('10 - Lost','10 - Lost'),
                                                                                            ('11 - Won','11 - Won'),
                                                                                            ('12 - GAPList Tracking Closed','12 - GAPList Tracking Closed')
                                                                                            ),
    ...
    def getitems(self):
        return {'id':self.pk, "oem_project_code":self.oem_project_code, "Description":self.Description, "vehicle_project_status":self.vehicle_project_status,"ts_qty":self.ts_qty,"Biz_Year":self.Biz_Year}


class Rail_Customer_Bidding(models.Model):
    OEM_Chance = models.CharField(max_length=5,choices=(('0%','0%'),('10%','10%'),('30%','30%'),('50%','50%'),('70%','70%'),('90%','90%'),('100%','100%')),verbose_name='OEM Chance Rate')
...
class Rail_Vehicle_Info(models.Model):
    ...
    Car_per_TS = models.DecimalField(max_digits=2, decimal_places=0,verbose_name='Car per Trainset')
    MCar_per_TS = models.DecimalField(max_digits=2, decimal_places=0,blank=True,null=True,verbose_name='Motive Car per Trainset')
    Speed_From = models.DecimalField(max_digits=5, decimal_places=2,blank=True,null=True,verbose_name='Speed From')
    Speed_To = models.DecimalField(max_digits=5, decimal_places=2,blank=True,null=True,verbose_name='Speed To')
    Vehicle_Price = models.FloatField(blank=True, null=True,verbose_name='Vehicle Price')
    TS_Config = models.CharField(max_length=100,blank=True,null=True,verbose_name='Trainset Configure')
...
#    id = models.IntegerField(max_length=11,verbose_name='ID',  primary_key=True)
    ...
    Customer_contract_no = models.CharField(max_length=100,verbose_name='Customer Contract NO')
...
#    id = models.IntegerField(max_length=11,verbose_name='ID',  primary_key=True)
    Reason = models.TextField(max_length=500, blank=True, null=True,verbose_name="Description")    
    Voith_Chance = models.CharField(max_length=5,choices=(('0%','0%'),('10%','10%'),('30%','30%'),('50%','50%'),('70%','70%'),('90%','90%'),('100%','100%')),verbose_name='VOITH Chance') #default is 0
    ...
    Commercial_Status = models.CharField(max_length=300,blank=True, null=True,verbose_name='Commercial Status')
    ...
    Technical_Status = models.CharField(max_length=300,blank=True, null=True,verbose_name='Technical Status')
    OEM_Principle = models.CharField(max_length=100,blank=True, null=True)
    Bidding_Status  = models.CharField(max_length=20,choices=
                                                                (('Won','Won'),('Closed','Closed'),('Lost','Lost'),('Delivered','Delivered'),('Tracking','Tracking'),('LOI Signed','LOI Signed'),('Contract Signed','Contract Signed'),('TBD','TBD'),
                                                                ('01 - Reach Goal','01 - Reach Goal'),
                                                                ('02 - New Project','02 - New Project'),
                                                                ('03 - RFQ','03 - RFQ'),
                                                                ('04 - Running','04 - Running'),
    ...
    Decision_Maker = models.ForeignKey(Decision_Maker,blank=True,null=True)  
    Total_Bidding_Price_exclude_VAT = models.DecimalField(max_digits=12, decimal_places=2,blank=True, null=True,verbose_name='Total Bidding Price Exclude VAT')   
   
    Rail_OEM_Project = models.ForeignKey( Rail_OEM_Project, to_field = 'id',  null=True)    
    Rail_Contract = models.ForeignKey( Rail_Contract, null=True, blank=True)  
    Currency = models.ForeignKey(Currency)    
    ...
    def getitems(self):
        ...
        return {'id':self.pk, "Reason":self.Reason, "Voith_Chance":self.Voith_Chance, "Bidding_Status":self.Bidding_Status,"Total_Bidding_Price_exclude_VAT":self.Total_Bidding_Price_exclude_VAT,"Decision_Maker":self.Decision_Maker}
...
#    Rail_OEM_Project = models.ForeignKey(Rail_OEM_Project)
    Rail_Bidding = models.ForeignKey(Rail_Bidding)
...
class Rail_Product_Setup(models.Model):
    Name = models.CharField(max_length=50,verbose_name='SETUP')
...
class Rail_Product_Setup_Value(models.Model):
    Name = models.CharField(max_length=50,verbose_name='SETUP Value')
...
class Rail_Product_Group(models.Model):
    Name = models.CharField(max_length=50,verbose_name='Rail Product Group')
...
class Rail_Product_Setup_Product_Setup_Value_r(models.Model): 
    ...
    class Meta:
        verbose_name = 'rel Rail Product Setup - Setup Type'  
...
#    id = models.IntegerField(max_length=11,verbose_name='ID',  primary_key=True)
    ...
    Description = models.TextField(max_length=500, verbose_name='Description',blank=True, null=True)    
...
#Added by Toni Dong        
class Product_lists(models.Model):
    Rail_Bidding = models.ForeignKey(Rail_Bidding)
    Description = models.TextField(max_length=300,blank=True, null=True,verbose_name='Description')
    Quantity = models.IntegerField(max_length=5,verbose_name='Quantity/Ts')
    Based_Price_exclude_VAT = models.DecimalField(max_digits=12, decimal_places=2,verbose_name='Unit Price')
    Rail_Configuration = models.ForeignKey(Rail_Configuration, blank=True, null=True, verbose_name='Rail Configuration')    
    Rail_Product_Group = models.ForeignKey(Rail_Product_Group, verbose_name='Rail Product Group')    
    Rail_Product_Type = models.ForeignKey(Rail_Product_Type, verbose_name='Rail Product Type')
    Rail_Product = models.ForeignKey(Rail_Product, verbose_name='Rail Product')
    ...
    '''    
    def getbidding(self):
        return "\n".join([p.Rail_Bidding for p in self.Rail_Bidding.all()])
    '''
    ''' 
    def getitems(self):
        return {'id':self.pk, "Description":self.Description, "Based_Price_exclude_VAT":self.Based_Price_exclude_VAT,}
    '''   
...
class Rail_Tracking(models.Model):
    OEM_Bidding = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='OEM Bidding Time')
    Voith_Bidding = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='VOITH Bidding Time') 
    LOI = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True)
    LOI_Kick_off = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='LOI Kick Off')
    TA = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True)
    TA_Kick_off = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='TA Kick off')
    Contract_Sign = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True)
    Contract_Kick_off = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='Contract Kick Off') 
    FAI = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True)
    First_Delivery = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True)
    Last_Delivery = models.DateField(auto_now=False, auto_now_add=False,blank=True, null=True,verbose_name='Last Delivery')
